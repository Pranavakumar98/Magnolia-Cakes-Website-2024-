...
ALLOWED_HOSTS = [BACKEND_URL,'localhost','magnoliacake.com.au']
...
EMAIL_FROM = 'enquiries.magnoliacake@gmail.com'
DEFAULT_FROM_EMAIL = 'enquiries.magnoliacake@gmail.com'
SERVER_EMAIL = 'enquiries.magnoliacake@gmail.com'

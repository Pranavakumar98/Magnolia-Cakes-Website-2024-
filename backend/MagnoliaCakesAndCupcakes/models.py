...
class FlavoursAndServingsInfo(models.Model):
    heading1 = models.CharField(max_length=200, verbose_name="Section 1 Heading")
    description1 = models.TextField(verbose_name="Section 1 Description")
    image1 = models.ImageField(upload_to="flavours_and_servings/", verbose_name="Section 1 Image")
    heading2 = models.CharField(max_length=200, verbose_name="Section 2 Heading")
    description2 = models.TextField(verbose_name="Section 2 Description")
    image2 = models.ImageField(upload_to="flavours_and_servings/", verbose_name="Section 2 Image")
    heading3 = models.CharField(max_length=200, verbose_name="Section 3 Heading")
    description3 = models.TextField(verbose_name="Section 3 Description")
    extra_points = models.TextField()
    image4 = models.ImageField(upload_to="flavours_and_servings/", verbose_name="Section 4 Image")
    image5 = models.ImageField(upload_to="flavours_and_servings/", verbose_name="Section 5 Image")
    image6 = models.ImageField(upload_to="flavours_and_servings/", verbose_name="Section 6 Image")
